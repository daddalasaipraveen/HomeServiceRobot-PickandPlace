...
xterm -e "cd ${path_catkin_ws}; source devel/setup.bash; roslaunch turtlebot_gazebo turtlebot_world.launch world_file:=\"/home/workspace/Project5/catkin_ws/src/map/world/myworld.world\"" &
sleep 5

xterm -e "cd ${path_catkin_ws}; source devel/setup.bash; roslaunch turtlebot_gazebo amcl_demo.launch map_file:=\"/home/workspace/Project5/catkin_ws/src/map/map.yaml\"" &
sleep 5

...
xterm -e "source devel/setup.bash; roslaunch turtlebot_rviz_launchers view_navigation.launch rviz_path:=\"/home/workspace/Project4-MapMyWorld/catkin_ws/src/rvizconfig/rvizConf.rviz\"" &
sleep 5
